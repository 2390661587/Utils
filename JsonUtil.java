...
/**
 * @author YL
 * @Desc 由于习惯了用fastjson处理JSON数据，突然改成用jackson，有些不适应，所以打算用jackson封装出类似fastjson里的方法进行使用
 * @since 2024-08-10 17:46:57
 */
...
public abstract class JsonUtil {
    ...
    public static <T> T parseObject(String jsonString, Class<T> object) {
        ...
        try {
            ...
            System.err.printf("JsonString转为自定义对象失败：%s", e.getMessage());
        }
        return t;
    }
    ...
    public static <T> T parseObject(File file, Class<T> object) {
        ...
        try {
            ...
            System.err.printf("从文件中读取json字符串转为自定义对象失败：%s", e.getMessage());
        }
        return t;
    }
    ...
    public static <T> T parseJSONArray(String jsonArray, TypeReference<T> reference) {
        ...
        try {
            ...
            System.err.printf("JSONArray转为List列表或者Map集合失败：%s", e.getMessage());
        }
        return t;
    }
    ...
    public static String toJSONString(Object object) {
        ...
        try {
            ...
            System.err.printf("Object转JSONString失败：%s", e.getMessage());
        }
        return jsonString;
    }
    ...
    public static byte[] toByteArray(Object object) {
        ...
        try {
            ...
            System.err.printf("Object转ByteArray失败：%s", e.getMessage());
        }
        return bytes;
    }
    ...
    public static void objectToFile(File file, Object object) {
        try {
            ...
            System.err.printf("Object写入文件失败：%s", e.getMessage());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static JsonNode parseJSONObject(String jsonString) {
        ...
        try {
            ...
            System.err.printf("JSONString转为JsonNode失败：%s", e.getMessage());
        }
        return jsonNode;
    }
    ...
    public static String toJSONString(JsonNode jsonNode) {
        ...
        try {
            ...
            System.err.printf("JsonNode转JSONString失败：%s", e.getMessage());
        }
        return jsonString;
    }
